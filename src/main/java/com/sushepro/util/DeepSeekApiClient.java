...
public class DeepSeekApiClient {
    private static final Logger logger = Logger.getLogger(DeepSeekApiClient.class);
    private static final String API_URL = "https://api.deepseek.com/v1/chat/completions";
    private static final String API_KEY = "sk-0b6f9c93355a441a8c8dc45a8d891653"; // 请替换为实际的DeepSeek API密钥
